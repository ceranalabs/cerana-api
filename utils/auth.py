...
PERMITTED_ORIGINS = os.environ.get('PERMITTED_ORIGINS', 'http://localhost:3000,http://localhost:5173,http://localhost:5001,https://cerana.netlify.app,https://zp1v56uxy8rdx5ypatb0ockcb9tr6a-oci3--5173--cb7c0bca.local-credentialless.webcontainer-api.io,https://app.ceranalabs.io,https://app.ceranalabs.com').split(',')
